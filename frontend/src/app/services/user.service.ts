...
export class UserService {
    ...
    getPage(page = 1, size = 10): Observable<any> {
        return this.http.get(`${this.userUrl}/getusers?page=${page}&size=${size}`).pipe();
    }
